...
describe('MaterialsInput', () => {
  ...
  it('preserves wildcard segments when converting back to chemical system mode', async () => {
    ...
    await user.click(screen.getByRole('button', { name: 'At least' }));
    await user.click(await screen.findByText('Only'));
